...
const quizData = [
    ...
    {
        question: "텍스트, 이미지, 음성 등 다양한 데이터를 동시에 처리할 수 있도록 설계된 멀티모달 AI 플랫폼 구조의 약어는?",
        options: ["MTP", "MCP", "MUX", "MMM", "MXP"],
        correct: 1,
        explanation: "MCP는 'Multimodal Capability Platform'의 약자로, 텍스트뿐 아니라 이미지, 음성, 영상 등 다양한 데이터를 동시에 처리할 수 있는 AI 플랫폼 구조입니다. GPT-4o, Gemini 등이 대표적인 멀티모달 모델입니다."
    },
    {
